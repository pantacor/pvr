...
func CommandRemoteInfo() cli.Command {
	return cli.Command{
		Name:        "remoteinfo",
		Aliases:     []string{"ri"},
		ArgsUsage:   "<remote-repository-ref>",
		Usage:       "resolve info about remote repository",
		Description: "resolve info about remote repository and print on stdout",
		Action: func(c *cli.Context) error {
			...
			jsonData, err := json.MarshalIndent(pvrRemote, "", "    ")
